...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_distributor_invoice_detail', function (Blueprint $table) {
            $table->increments('idtbl_dis_invoice_detailid');
            ...
            $table->integer('tbl_distributor_invoice_id');
    ...
    {
        Schema::dropIfExists('tbl_distributor_invoice_detail');
    }
};
